...
public class Order {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(id, order.id) && Objects.equals(description, order.description)
				&& Objects.equals(food, order.food) && Objects.equals(vip, order.vip)
				&& Objects.equals(pickup, order.pickup) && Objects.equals(delivery, order.delivery);
	}
	...
	public String toString() {
		return "Order{" + "id='" + id + '\'' + ", description='" + description + '\'' + ", food=" + food + ", vip="
				+ vip + ", pickup=" + pickup + ", delivery=" + delivery + '}';
	}
}
