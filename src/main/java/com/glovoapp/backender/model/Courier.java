...
public class Courier {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(id, courier.id) && Objects.equals(name, courier.name) && Objects.equals(box, courier.box)
				&& vehicle == courier.vehicle && Objects.equals(location, courier.location);
	}
	...
	public String toString() {
		return "Courier{" + "id='" + id + '\'' + ", name='" + name + '\'' + ", box=" + box + ", vehicle=" + vehicle
				+ ", location=" + location + '}';
	}
}
